...
OK - finally, with that leg work done, it's time to set up Capistrano itself.  On your local machine (you don't need to install anything on the production server):
